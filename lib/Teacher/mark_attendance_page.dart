...
class _MarkAttendancePageState extends State<MarkAttendancePage>
  ...
  final List<Student> _students = [
    Student(id: '1', name: 'Aarav Sharma',    rollNo: '001', avatarInitials: 'AS', avatarColor: const Color(0xFF3B82F6)),
    Student(id: '2', name: 'Priya Mehta',     rollNo: '002', avatarInitials: 'PM', avatarColor: const Color(0xFF10B981)),
    Student(id: '3', name: 'Rohan Verma',     rollNo: '003', avatarInitials: 'RV', avatarColor: const Color(0xFFF59E0B)),
    Student(id: '4', name: 'Sneha Patel',     rollNo: '004', avatarInitials: 'SP', avatarColor: const Color(0xFFEF4444)),
    Student(id: '5', name: 'Kiran Joshi',     rollNo: '005', avatarInitials: 'KJ', avatarColor: const Color(0xFF8B5CF6)),
    Student(id: '6', name: 'Ananya Rao',      rollNo: '006', avatarInitials: 'AR', avatarColor: const Color(0xFFEC4899)),
    Student(id: '7', name: 'Dev Gupta',       rollNo: '007', avatarInitials: 'DG', avatarColor: const Color(0xFF06B6D4)),
    Student(id: '8', name: 'Meera Nair',      rollNo: '008', avatarInitials: 'MN', avatarColor: const Color(0xFF84CC16)),
    Student(id: '9', name: 'Arjun Singh',     rollNo: '009', avatarInitials: 'AS', avatarColor: const Color(0xFFF97316)),
    Student(id: '10', name: 'Tanvi Desai',    rollNo: '010', avatarInitials: 'TD', avatarColor: const Color(0xFF6366F1)),
    Student(id: '11', name: 'Vikram Bose',    rollNo: '011', avatarInitials: 'VB', avatarColor: const Color(0xFF14B8A6)),
    Student(id: '12', name: 'Ishaan Kapoor',  rollNo: '012', avatarInitials: 'IK', avatarColor: const Color(0xFFA78BFA)),
  ];
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('OK',
                style: TextStyle(
                    color: Color(0xFF1A3DB5), fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(
                    color: Color(0xFF9098A3), fontSize: 13),
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: const AlwaysStoppedAnimation<Color>(Color(0xFF1A3DB5)),
            ),
          ),
